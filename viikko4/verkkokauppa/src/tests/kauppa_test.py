...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilisiirto_kutsu_kahdella_ostoksella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        def varasto_hae_tuote(tuote_id):
            if tuote_id == 1:
                return Tuote(1, "maito", 5)
            if tuote_id == 2:
                return Tuote(2, "Sierra Nevada Pale Ale", 5)
    ...
    def test_tilisiirto_kahdella_samalla_ostoksella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_uusi_hinta(self):
        ...
        pankki_mock.tilisiirto.assert_called_with("liisa", 42, "54321", "33333-44455", 5)    
